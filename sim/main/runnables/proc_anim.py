...
PROCESS_FLOW_SPEED = 1000
WIDTH = 1800
HEIGHT = 1000
SCALE = 1.0
BACKGROUND_IMAGE = "main/model/bpmn/diagram.png"
ENTITY_ICON = "main/model/img/simple_entity_icon.png"
...
class RunnableTourSimProcess(RunnableSimulation):
    ...
    def simulate(
        ...
        model = Model(env)
        model.truck_source.max_entities = 1
